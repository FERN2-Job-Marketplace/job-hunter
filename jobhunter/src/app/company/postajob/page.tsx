            ...
            <form>
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <input type="text" placeholder="Eg. Frontend Developer" className="input input-bordered w-full max-w-sm" />
                        </div>
                    </div>
                </div>
                <hr />
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <select className="select select-bordered text-raisin-black w-full max-w-sm">
                                <option disabled selected>Select Type of Employments</option>
                ...
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <input type="number" placeholder="Rp" className="input input-bordered w-full max-w-sm" />
                        </div>
                    </div>
                </div>
                <hr />
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <select className="select select-bordered text-raisin-black w-full max-w-sm">
                                <option disabled selected>Select Job Categories</option>
                ...
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <textarea className="textarea textarea-bordered h-36 w-full" placeholder="Responsibilities"></textarea>
                        </div>
                    </div>
                </div>
                <hr />
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <textarea className="textarea textarea-bordered h-36 w-full" placeholder="Requirements"></textarea>
                        </div>
                    </div>
                </div>
                <hr />
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <textarea className="textarea textarea-bordered h-36 w-full" placeholder="Nice to Haves"></textarea>
                        </div>
                    </div>
                </div>
                <hr />
                <div className="dashboardPostjobsSection my-5">
                    <div className="flex flex-wrap">
                        ...
                        <div className="inputWrap md:w-6/12">
                            <textarea className="textarea textarea-bordered h-36 w-full" placeholder="Perks and Benefits"></textarea>
                        </div>
                    </div>
                </div>
